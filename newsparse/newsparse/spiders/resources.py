resources = [
        ('Новостной портал nur.kz', 'https://nur.kz/latest, scrolling 1 2',
        ...
        ('Новостной портал scientificrussia.ru',
         'https://scientificrussia.ru/news, pagination 1132 1130 -1 f"https://scientificrussia.ru/news/{i}"',
         'image, div, , a',
...
# resource_url = 'https://nur.kz/latest, scrolling 1 2'
...
# resource_url = 'https://scientificrussia.ru/news, pagination 1132 1130 -1 f"https://scientificrussia.ru/news/{i}"'
# top_tag = 'image, div, , a'
