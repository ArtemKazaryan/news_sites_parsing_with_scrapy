...
<<<<<<< HEAD
9. Предусмотренно удаление данных из таблицы items БД в SQLiteStudio командой 'DELETE FROM' items в окне редактора (Alt+E)
=======
9. Предусмотренно удаление данных из таблицы items БД в SQLiteStudio командой 'DELETE FROM' items в окне редактора (Alt+E)
>>>>>>> 2d0f3127c176d4f16641cc1067962ff108454d77
